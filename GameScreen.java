...
public class GameScreen extends JFrame {
    ...
    public GameScreen() {
        ...
        routeback = new JLabel(new ImageIcon(routebackImg.getImage().getScaledInstance((int)(cardWidth/6), (int)(cardHeight/6), Image.SCALE_SMOOTH)));
        ...
        routeback.setBounds(getWidth()-400,getHeight()-500,(int)(433*1.7),(int)(577*1.2));
